...
public class LocationServiceApplication {
    ...
    public Docket api() throws IOException, XmlPullParserException {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.erp.location.controller"))
                //.apis(RequestHandlerSelectors.any())
                .paths(PathSelectors.any())
                .build().apiInfo(new ApiInfo("Location Service API Documentation", "Generated By System"+System.currentTimeMillis(), "1.0.0", null, null, null, null));
    }
